...
final class MonitorSlotResolverTests: XCTestCase {
    func testSlotsUseMainDisplayFirstThenDistanceFromMainDisplay() {
        let resolver = MonitorSlotResolver(displayProvider: FakeDisplayProvider(snapshots: [
            DisplaySnapshot(id: 10, frame: CGRect(x: 2000, y: 0, width: 1000, height: 1000), isMain: false),
            DisplaySnapshot(id: 20, frame: CGRect(x: 0, y: 0, width: 1000, height: 1000), isMain: true),
            DisplaySnapshot(id: 30, frame: CGRect(x: -1000, y: 0, width: 1000, height: 1000), isMain: false)
        ]))
