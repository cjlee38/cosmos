...
final class SpaceApplicationIconStripView: NSView {
    private var applications: [WindowSwitcherItem] = []
    private var iconViews: [NSImageView] = []
    private let overflowView = SpaceApplicationOverflowView()
...
private final class SpaceApplicationOverflowView: NSView {
