...
final class OnboardingCoordinator {
    ...
    init(
        ...
        spaceSettingsService: any SpaceSettingsServing,
...
private final class OnboardingWindowController: NSWindowController, NSWindowDelegate {
    ...
    init(contentViewController: OnboardingViewController) {
        ...
        window.title = "Set Up Cosmos"
        window.isReleasedWhenClosed = false
        window.collectionBehavior = [.moveToActiveSpace]
        window.minSize = NSSize(width: 820, height: 620)
        window.setAccessibilityIdentifier("cosmos.onboarding")
...
final class OnboardingViewController: NSViewController {
    ...
    override func loadView() {
        ...
        configureStepLabel(spacesStepLabel)
    ...
    private func configureNavigationButtons() {
        ...
        backButton.setAccessibilityIdentifier("cosmos.onboarding.back")
        continueButton.target = self
        continueButton.action = #selector(continueSetup)
        continueButton.bezelStyle = .rounded
        continueButton.controlSize = .large
        continueButton.keyEquivalent = "\r"
        continueButton.setAccessibilityIdentifier("cosmos.onboarding.continue")
    }

    private func makeHeader() -> NSStackView {
        let title = NSTextField(labelWithString: "Set Up Cosmos")
    ...
    private func updateNavigation() {
        ...
        spacesStepLabel.textColor = isPermissionsStep ? .secondaryLabelColor : .labelColor
        ...
        if isPermissionsStep {
            ...
            continueButton.title = "Start Cosmos"
