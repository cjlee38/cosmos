...
class SpaceControllerTestCase: XCTestCase {
...
final class SpaceControllerTests: SpaceControllerTestCase {
    ...
    func testSwitchHidesOtherSpacesAndRestoresTargetSpace() throws {
        let windowSystem = FakeWindowSystem(windows: [
    ...
    func testSwitchRestoresAndFocusesTargetBeforeHidingPreviousSpace() throws {
        let windowSystem = FakeWindowSystem(windows: [
            .window(id: 100, title: "One"),
    ...
    func testSwitchFailsWhenPreviousSpaceWindowCannotBeHidden() throws {
        let windowSystem = FakeWindowSystem(windows: [
        ...
        XCTAssertEqual(controller.spacesByRecency.first, "1")
        XCTAssertFalse(controller.isHiddenBySpace(100))
        XCTAssertTrue(controller.isHiddenBySpace(200))
    }
    ...
    func testExternalFocusEventRefreshesWindowStateOnce() throws {
        ...
        XCTAssertEqual(windowSystem.refreshCount, 1)
        XCTAssertEqual(result.focusedWindowSync, .switched(windowID: 200, space: "2"))
    }

    func testWindowSetChangedRepairsInactiveSpaceVisibility() throws {
        let windowSystem = FakeWindowSystem(windows: [
            .window(id: 100, title: "One"),
            .window(id: 200, title: "Two")
        ])
